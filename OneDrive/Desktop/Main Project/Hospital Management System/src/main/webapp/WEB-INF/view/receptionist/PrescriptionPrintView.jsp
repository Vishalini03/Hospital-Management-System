...
<script>
	...
	<div class="container"><br/>
		...
		<div class="row">
			<div class="col-sm-5">
			<h1><span style="color:grey;">H</span><span style="color:red;">M</span><span style="color:grey;">S</span> HOSPITAL</h1>
			</div>
			<div class="col-sm-7">
			<p><b>Dr. Radha</b><br/> MBBS, DNB(Gen. Surgeon), MS</p>
			</div>
		</div>
		<hr/>
	<div class="demo">
			...
			<div>
				...
				<hr/>
				Our Centers:<br/>
			    1. HMS Hospital, Five roads, Salem, Tamil Nadu - 673809 |
			    2. HMS Multispeciality Hospital, Gandhipuram, Coimbatore, Tamil Nadu - 674890<br/>
			    Mobile No.7896489375 | Phone No. 04287-21117 | E-mail: hmshospital@gmail.com		
			</div>	
